...
class Pattern(ABC):
    ...
    def match_all(self, tokens: List[Union['Token', 'TokenGroup']], 
                  dialect: 'SQLDialect') -> List[MatchResult]:
        """
...
class PatternRegistry:
    ...
    def get_by_type(self, pattern_class: type, dialect: Optional[str] = None) -> List[Pattern]:
        """
