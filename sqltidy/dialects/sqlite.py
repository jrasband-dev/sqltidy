...
class SQLiteDialect(SQLDialect):
    ...
    def keywords(self) -> Set[str]:
        ...
        return {kw.lower() for kw in {
            ...
            'TABLE', 'VIEW', 'INDEX', 'TRIGGER', 'VIRTUAL',
            ...
            'PRAGMA', 'DATABASE', 'SCHEMA', 'ATTACH', 'DETACH',
            'VACUUM', 'ANALYZE', 'REINDEX', 'EXPLAIN', 'QUERY', 'PLAN',
            
            # Table options
            'TEMPORARY', 'TEMP', 'IF', 'ELSE', 'ELSIF',
            'WITHOUT', 'ROWID',
            ...
            # Other keywords
            'INDEXED', 'BY', 'ESCAPE', 'ISNULL', 'NOTNULL',
            'RAISE', 'EACH', 'FOR', 'INSTEAD', 'OF',
    ...
    def data_types(self) -> Set[str]:
        ...
        return {dt.lower() for dt in {
            ...
            'CHARACTER', 'VARCHAR', 'VARYING', 'NCHAR',
            'NATIVE', 'NVARCHAR', 'CLOB',
    ...
    def functions(self) -> Set[str]:
        ...
        return {fn.lower() for fn in {
            ...
            'HEX', 'IFNULL', 'IIF', 'INSTR', 'LAST_INSERT_ROWID',
            ...
            'CEIL', 'CEILING', 'COS', 'COSH', 'DEGREES', 'EXP',
            'FLOOR', 'LN', 'LOG', 'LOG10', 'LOG2', 'MOD',
            'PI', 'POW', 'POWER', 'RADIANS', 'SIN', 'SINH',
            'SQRT', 'TAN', 'TANH', 'TRUNC',
