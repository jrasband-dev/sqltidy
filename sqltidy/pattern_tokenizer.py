...
def apply_patterns(tokens: List[Union[Token, TokenGroup]], 
                   dialect: SQLDialect,
                   parent_group_type: Optional[GroupType] = None) -> List[Union[Token, TokenGroup]]:
    """
...
def _apply_single_pattern(tokens: List[Union[Token, TokenGroup]], 
                          pattern: Pattern,
                          dialect: SQLDialect,
                          parent_group_type: Optional[GroupType]) -> List[Union[Token, TokenGroup]]:
    """
