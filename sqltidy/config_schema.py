...
import json
from .rules.base import BaseRule, ConfigField, build_config_schema_from_rules, generate_config_defaults, get_config_descriptions
...
def generate_dialect_config(dialect: str, include_plugins: bool = True) -> Dict[str, Any]:
    """
...
def save_dialect_config_to_json(dialect: str, filepath: str, include_plugins: bool = True):
    """
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        if sys.argv[1] == "summary":
            ...
            print("Usage:")
            print("  python -m sqltidy.config_schema summary      # Print config schema")
            print("  python -m sqltidy.config_schema regenerate   # Regenerate JSON files")
    else:
        print("Regenerating bundled configuration files...")
        regenerate_all_bundled_configs()
        print("\nDone!")
