...
class BaseRule:
    ...
    def find_tokens(self, tokens: List[Union[Token, TokenGroup]], 
                   token_type: TokenType = None, 
                   value: str = None,
                   group_type: GroupType = None) -> List[Union[Token, TokenGroup]]:
        ...
        for item in tokens:
            if isinstance(item, Token):
                ...
                if group_type and item.group_type != group_type:
                    ...
                    results.extend(self.find_tokens(item.tokens, token_type, value, group_type))
                else:
                    if group_type:
                        results.append(item)
                    # Search within group
    ...
    def insert_after(self, tokens: List[Union[Token, TokenGroup]], 
                    after: Union[Token, TokenGroup],
                    new_tokens: List[Union[Token, TokenGroup]]) -> List[Union[Token, TokenGroup]]:
    ...
    def insert_before(self, tokens: List[Union[Token, TokenGroup]], 
    ...
    def replace_token(self, tokens: List[Union[Token, TokenGroup]],
                     old: Union[Token, TokenGroup],
                     new: Union[Token, TokenGroup, List[Union[Token, TokenGroup]]]) -> List[Union[Token, TokenGroup]]:
