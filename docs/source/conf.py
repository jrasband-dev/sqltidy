...
try:
    sys.path.insert(0, str(Path("../../sqltidy").resolve()))
    from sqltidy import __version__
...
# key site root paths
static_assets_root = ""
github_root = "https://github.com/jrasband-dev/sqltidy"
web_root = "https://jrasband-dev.github.io/sqltidy/"
asset_root = "https://raw.githubusercontent.com/jrasband-dev/sqltidy/main"

# Specify version for version switcher dropdown menu
git_ref = os.environ.get("SQLTIDY_VERSION", "main")
...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "Pypi",
            "url": "https://pypi.org/project/sqltidy/",
...
def linkcode_resolve(domain: str, info: dict[str, Any]) -> str | None:
    ...
    project_root = (conf_dir_path.parent.parent / "sqltidy").absolute()

    fn = os.path.relpath(fn, start=project_root)
    return f"{github_root}/blob/{git_ref}/sqltidy/{fn}{linespec}"
